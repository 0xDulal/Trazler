...
const NewsletterCard = () => {
      return (
            <div className="flex flex-col items-center w-full max-w-7xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
                  <div className="flex flex-col justify-center items-center text-center">
                        ...
                        <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-xl">
                              ...
                              new updates, exclusive offers, and inspiration.
                        </p>
                  </div>
